    ...
    public class Basic
    {
        ...
        static void docmd()
        {
            ...
            while (true)
            {
                ...
                switch (tok)
                {
                    case "bye": isRunning = false; return;
        ...
        static void gosubstmt()
        {   // for gosub: save the line and column
        ...
        static int expression(int minprec)
        {
            ...
            {
                nexttok(); n = expression(3); if (n != 0) n = 1;
            }
            else if (tok == "abs")
            {
            ...
            {
                nexttok(); expect("("); n = tok[1]; nexttok(); expect(")");
            }
            else if (tok == "rnd" || tok == "irnd")
            {
                nexttok(); n = random.Next(1, parenexpr());
            }
            else if (tok == "sgn")
            {
            ...
            { // while binary operator and precedence of tok >= minprec
                ...
                {
                    nexttok(); n = (int)Math.Pow(n, expression(9));
                }
                else { break; }
            }
            return n;
